...
import com.example.traccite.HomeActivity;
...
public class BtleBackgroundScanService extends Service {
  ...
  private void startScanning() {
    proximityManager.connect(new OnServiceReadyListener() {
      ...
      public void onServiceReady() {
        ...
        devicesCount = 0;
        Toast.makeText(BtleBackgroundScanService.this, "Scanning service started.", Toast.LENGTH_SHORT).show();
      }
    });
    //stopAfterDelay();
  }
  ...
  public void onDestroy() {
    ...
    Toast.makeText(BtleBackgroundScanService.this, "Scanning service stopped.", Toast.LENGTH_SHORT).show();
    super.onDestroy();
  }
}
